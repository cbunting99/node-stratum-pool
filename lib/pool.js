...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    function OnBlockchainSynced(syncedCallback){
        ...
        var generateProgress = function(){
            ...
            var cmd = options.coin.hasGetInfo ? 'getinfo' : 'getblockinfo';
    ...
    function DetectCoinData(finishedCallback){
        ...
        if (options.coin.hasGetInfo) {
            ...
            batchRpcCalls.push(['getblockinfo', []], ['getnetworkinfo', []]);
        }
        _this.daemon.batchCmd(batchRpcCalls, function(error, results){
            ...
            options.testnet = options.coin.hasGetInfo ? rpcResults.getinfo.testnet : (rpcResults.getblockinfo.chain === 'test') ? true : false;
            ...
            var difficulty = options.coin.hasGetInfo ? rpcResults.getinfo.difficulty : rpcResults.getblockinfo.difficulty;
