...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    function OnBlockchainSynced(syncedCallback){
        ...
        var generateProgress = function(){
            ...
            var cmd = options.coin.hasGetInfo ? 'getinfo' : 'getnetworkinfo';
    ...
    function DetectCoinData(finishedCallback){
        ...
        if (options.coin.hasGetInfo) {
            ...
            batchRpcCalls.push(['getinfo', []], ['getnetworkinfo', []]);
        }
        _this.daemon.batchCmd(batchRpcCalls, function(error, results){
            ...
            options.testnet = options.coin.hasGetInfo ? rpcResults.getinfo.testnet : (rpcResults.getinfo.chain === 'test') ? true : false;

            options.protocolVersion = options.coin.hasGetInfo ? rpcResults.getinfo.protocolversion : rpcResults.getinfo.protocolversion;
            ...
            options.initStats = {
                connections: (options.coin.hasGetInfo ? rpcResults.getinfo.connections : rpcResults.getinfo.connections),
